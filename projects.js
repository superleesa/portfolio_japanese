...
records = [
    ...
    date: "2023 10月", description: "質問の目的を分類する問題において、様々なモデルを試した結果、Transformer, LSTMとTextCNNをスタックしたモデルを採用し、keras-tunerを用いてhyper-parameterの最適化をしたのちに、正解率 >=0.98を達成しました。（大学の課題の一貫で、取り組みました。）",
